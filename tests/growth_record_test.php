...
t('ext: m4a 3gpp (삼성 음성녹음)', growthAudioExt('video/3gpp') === 'm4a');
t('ext: m4a audio/3gpp', growthAudioExt('audio/3gpp') === 'm4a');
t('ext: m4a quicktime', growthAudioExt('video/quicktime') === 'm4a');
t('ext: aac adts', growthAudioExt('audio/x-hx-aac-adts') === 'aac');
t('ext: aac', growthAudioExt('audio/aac') === 'aac');
